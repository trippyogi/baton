...
- [x] **T1.6** Port routes incrementally with snapshot/parity tests. *(in progress: health, overview, agents, alerts, runs, tasks, builds, touches, flow, dispatch, team, review-packets, queue; skip costs/performance Meta surfaces)*
